...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "size-7 bg-sidebar hover:bg-sidebar rounded-l-none fixed top-7",
        className
      )}
      onClick={(event) => {
        onClick?.(event);
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 py-7 px-2", className)}
      {...props}
    />
  );
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col py-7 px-2",
        className
      )}
      {...props}
    />
